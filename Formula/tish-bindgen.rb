...
class TishBindgen < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/tishlang/tish/releases/download/v2.0.0/tish-bindgen-darwin-arm64"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/tishlang/tish/releases/download/v2.0.0/tish-bindgen-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/tishlang/tish/releases/download/v2.0.0/tish-bindgen-linux-arm64"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/tishlang/tish/releases/download/v2.0.0/tish-bindgen-linux-x64"
