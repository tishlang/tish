...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    let mut console = Value::Object(Rc::new(RefCell::new(HashMap::from([
    ...
    let Math = Value::Object(Rc::new(RefCell::new(HashMap::from([
    ...
    let JSON = Value::Object(Rc::new(RefCell::new(HashMap::from([
